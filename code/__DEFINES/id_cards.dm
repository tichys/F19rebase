...
/// Wildcard slot define for basic grey cards. Only hold 5 common wildcards.
#define WILDCARD_LIMIT_GREY list(WILDCARD_NAME_COMMON = list(limit = 5, usage = list()))
/// Wildcard slot define for Head of Staff silver cards. Can hold 5 common, 2 command and 1 private command.
...
/// Wildcard slot define for Chameleon/Agent ID grey cards. Can hold 5 common, 2 command and 1 captain access.
