...
/datum/crewmonitor
	...
	var/list/jobs = list(
		...
		JOB_ETHICS_COMMITTEE_LIAISON = 01,
		JOB_INTERNAL_TRIBUNAL_DEPARTMENT_OFFICER = 02,
		JOB_COMMUNICATIONS_DIRECTOR = 03,
		JOB_GOC_REP = 04,
		JOB_GOLDBAKER_REP = 05,
		JOB_MCD_REP = 06,
		JOB_UIU_REP = 07,

		// 10-29: Security
		JOB_SECURITY_DIRECTOR = 10,
		JOB_INVESTIGATIONS_AGENT = 11,
		JOB_RAISA_AGENT = 12,

		// 20-29: EZ Security
		JOB_EZ_COMMANDER = 20,
		JOB_SENIOR_EZ_GUARD = 21,
		JOB_EZ_GUARD = 22,
		JOB_JUNIOR_EZ_GUARD = 23,

		// 30-39: LCZ Security
		JOB_LCZ_COMMANDER = 30,
		JOB_SENIOR_LCZ_GUARD = 31,
		JOB_LCZ_GUARD = 32,
		JOB_JUNIOR_LCZ_GUARD = 33,

		// 40-49: HCZ Security
		JOB_HCZ_COMMANDER = 40,
		JOB_SENIOR_HCZ_GUARD = 41,
		JOB_HCZ_GUARD = 42,
		JOB_JUNIOR_HCZ_GUARD = 43,

		//50-59: Science
		JOB_RESEARCH_DIRECTOR = 50,
		JOB_ASSISTANT_RESEARCH_DIRECTOR = 51,
		JOB_SENIOR_RESEARCHER = 52,
		JOB_RESEARCHER = 53,
		JOB_JUNIOR_RESEARCHER = 54,

		// 60-69: Medical
		JOB_MEDICAL_DIRECTOR = 60,
		JOB_ASSISTANT_MEDICAL_DIRECTOR = 61,
		JOB_SURGEON = 62,
		JOB_CHEMIST = 63,
		JOB_VIROLOGIST = 64,
		JOB_MEDICAL_DOCTOR = 65,
		JOB_PARAMEDIC = 66,
		JOB_TRAINEE_DOCTOR = 67,
		JOB_PSYCHOLOGIST = 68,

		// 70-79: Engineering
		JOB_ENGINEERING_DIRECTOR = 70,
		JOB_ASSISTANT_ENGINEERING_DIRECTOR = 71,
		JOB_CONTAINMENT_ENGINEER = 72,
		JOB_IT_TECHNICIAN = 73,
		JOB_COMMS_PROGRAMMER = 74,
		JOB_ATMOSPHERIC_TECHNICIAN = 75,
		JOB_SENIOR_ENGINEER = 76,
		JOB_ENGINEER = 77,
		JOB_JUNIOR_ENGINEER = 78,

		// 80-89: Logistics
		JOB_LOGISTICS_OFFICER = 80,
		JOB_LOGISTICS_TECHNICIAN = 82,

		// 90+: Civilian/other
		JOB_HUMAN_RESOURCES_DIRECTOR = 90,
		JOB_COOK = 91,
		JOB_BOTANIST = 92,
		JOB_CHAPLAIN = 93,
		JOB_CLOWN = 94,
