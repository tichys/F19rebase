...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_ARMS_RESTRAINED" = TRAIT_ARMS_RESTRAINED,
		...
		"TRAIT_HIDE_COSMETIC_ORGANS" = TRAIT_HIDE_COSMETIC_ORGANS,
		...
		"TRAIT_MEMETIC_BLIND" = TRAIT_MEMETIC_BLIND,
		"TRAIT_MEMETIC_DEAF" = TRAIT_MEMETIC_DEAF,
		"TRAIT_PESTILENCE" = TRAIT_PESTILENCE
	),
