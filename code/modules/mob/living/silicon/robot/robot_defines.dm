...
// ------------------------------------------ Status
	...
	var/ident = 0
	var/locked = TRUE
	var/list/req_access = list(ACCESS_SCIENCE_LVL2)
...
/mob/living/silicon/robot/model/syndicate/saboteur
	...
	playstyle_string = "<span class='big bold'>You are a Syndicate saboteur cyborg!</span><br>\
						...
						Your cyborg chameleon projector allows you to assume the appearance and registered name of an Ananke engineering borg, and undertake covert actions on the station \
