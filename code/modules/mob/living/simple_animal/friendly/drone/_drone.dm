...
/mob/living/simple_animal/drone/Initialize(mapload)
	...
	var/datum/id_trim/job/cap_trim = SSid_access.trim_singletons_by_path[/datum/id_trim/job/site_director]
...
/mob/living/simple_animal/drone/examine(mob/user)
	. = list("<span class='info'>This is [icon2html(src, user)] \a <b>[src]</b>!<hr>") //PARIAH EDIT CHANGE
