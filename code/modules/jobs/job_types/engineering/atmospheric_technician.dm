/datum/job/atmospheric_technician
	...
	outfits = list(
		"Default" = list(
			SPECIES_HUMAN = /datum/outfit/job/atmospheric_technician,
			SPECIES_PLASMAMAN = /datum/outfit/job/atmospheric_technician/plasmaman,
		),
	)
...
/datum/outfit/job/atmospheric_technician/plasmaman
