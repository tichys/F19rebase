...
/datum/outfit/job/it_technician
	name = "IT Technician"
	jobtype = /datum/job/it_technician
...
/datum/outfit/job/it_technician/curator
	name = "Curator"
	jobtype = /datum/job/it_technician
...
/datum/outfit/job/it_technician/curator/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	..()
