/datum/job/goldbaker_rep
	...
	total_positions = 1
	spawn_positions = 1
	supervisors = "the Goldbaker-Reinz Chaotic Systems Intelligence Data Feed"
	...
	family_heirlooms = list(/obj/item/storage/secure/briefcase)
...
/datum/outfit/job/goldbaker_rep
	...
	jobtype = /datum/job/goldbaker_rep
