...
/datum/say_list/scp1507
	var/emote_hear = list("flaps its wings")
	var/emote_see = list("flaps its wings", "scratches the ground")
...
/mob/living/simple_animal/hostile/retaliate/scp1507/proc/lay_down()
	icon_state = resting ? icon_resting : icon_living
/* We need natural weapons
