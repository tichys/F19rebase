...
/datum/component/wearertargeting/punchcooldown/proc/reducecooldown(mob/living/carbon/M, atom/target, proximity, modifiers)
	if(((M.istate & ISTATE_HARM) && isliving(target)) || istype(M.get_active_held_item(), /obj/item/hand_item/slapper))
