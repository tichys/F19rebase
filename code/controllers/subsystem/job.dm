...
/datum/controller/subsystem/job/proc/promote_to_department_head(mob/living/carbon/human/new_head, datum/job/assigned_job)
	var/obj/item/id_slot = new_head.get_item_by_slot(ITEM_SLOT_ID)
	if(!id_slot)
		return NONE
